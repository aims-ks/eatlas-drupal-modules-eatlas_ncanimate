// Class
function EAtlasNcAnimateMap(htmlBlockElement, videoSelector) {
...
EAtlasNcAnimateMap.prototype.selectRegion = function(region) {
...
EAtlasNcAnimateMap.prototype.load = function(regionCatalogue) {
...
EAtlasNcAnimateMap.prototype.loadMap = function() {
		...
		return function(e) {
			...
			if (clickedRegion != null) {
				...
				eatlas_ncanimate_set_anchor(
					eatlas_ncanimate_craft_anchor({"region": clickedRegion})
				);
...
EAtlasNcAnimateMap.prototype.mergeBBox = function(bbox1, bbox2) {
	if (bbox1 === null) {
		if (bbox2 === null) {
			return null;
		}
 ...
 *     - ${HEIGHT}
 */
EAtlasNcAnimateMap.prototype.getMapURL = function() {
...
EAtlasNcAnimateMap.prototype.getRegionId = function(x, y) {
...
EAtlasNcAnimateMap.prototype.loadRegionCache = function() {
	var orderedRegions = this.getOrderedRegions();
...
EAtlasNcAnimateMap.prototype.populateHTMLRegionList = function() {
	var that = this;
		...
		for (var i=0; i<geographicallyOrderedRegions.length; i++) {
			...
			this.htmlRegionList.append(
				jQuery(regionId === this.selectedRegion ? '<li class="selected"></li>' : '<li></li>').append(
					...
					jQuery('<a class="' + regionId + '" href="#' + eatlas_ncanimate_craft_anchor({"region": regionId}) + '">' + this.regionCache[regionId]['label'] + '</a>')
...
EAtlasNcAnimateMap.prototype.getOrderedRegions = function() {
...
EAtlasNcAnimateMap.prototype.getMapBBox = function() {
...
EAtlasNcAnimateMap.prototype.getMapWidth = function() {
	if (this.width === null) {
...
EAtlasNcAnimateMap.prototype.getMapHeight = function() {
	if (this.height === null) {
		this.computeMapWidthHeight();
	}
	return this.height;
...
EAtlasNcAnimateMap.prototype.computeMapWidthHeight = function() {
	var mapBBox = this.getMapBBox();
...
EAtlasNcAnimateMap.prototype.redraw = function() {
	var width = this.getMapWidth(),
		height = this.getMapHeight();
...
EAtlasNcAnimateMap.prototype.drawRegion = function(regionId) {
...
EAtlasNcAnimateMap.prototype.reproject = function(bbox) {
	var mapBBox = this.getMapBBox(),
		width = this.getMapWidth(),
		height = this.getMapHeight();
